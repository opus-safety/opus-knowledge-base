...
| Report type | Often used by sector | Description | Examples |
| :--- | :--- | :--- | :--- |
...
| Employee intervention | <span class="mb-label mb-label-slate">Any</span> | Used for where action needs to be taken place against an employee. It is typically used as a sub-task for a near miss or accident, particularly when such events are caused by an act or omission of staff behaviour. | Examples include instances where an employee has been observed not wearing PPE or where an incident necessitates retraining. |

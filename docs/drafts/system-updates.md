...
??? feature-release "Feature release: New task features & improvements<span class="meta">16th September 2026</span>"
    ...
    ??? outline "<span class="mb-label mb-label-mauve">:lucide-arrow-up-circle: Improvements to existing field types</span>"
        ...
        | :--- | :--- | :--- |
        | Employee | <span data-uuid="458baba3-8b25-4f13-a904-3660ccdabdb0" style="display:none"></span>![](../assets/media/system-update-captures/who-is-investigating-9679ad5a-light-mode.png#only-light){ width="200" loading=lazy } ![](../assets/media/system-update-captures/who-is-investigating-9679ad5a-dark-mode.png#only-dark){ width="200" loading=lazy } | <span data-uuid="a7f07dcd-e8ae-4fe8-89de-a7d6ee32e8e9" style="display:none"></span>![](../assets/media/system-update-captures/pick-employee-z-1f28efe9-light-mode.png#only-light){ width="250" loading=lazy } ![](../assets/media/system-update-captures/pick-employee-z-1f28efe9-dark-mode.png#only-dark){ width="250" loading=lazy } |

...
!!! step
    ...
    ![](../assets/media/occ-captures/admin/sites/uuid/edit/located-at-light-mode.png#only-light)
    ![](../assets/media/occ-captures/admin/sites/uuid/edit/located-at-dark-mode.png#only-dark)

...
!!! step
    ...
    <span data-uuid="77393bab-8d0b-4790-817c-d9f5d51f151f" style="display:none"></span>
    ![](../assets/media/occ-captures/admin/sites/uuid/contractors/new/located-at-light-mode.png#only-light){ style="border-radius: 8px" loading=lazy }
    ![](../assets/media/occ-captures/admin/sites/uuid/contractors/new/located-at-dark-mode.png#only-dark){ style="border-radius: 8px" loading=lazy }
...
!!! step
    ...
    ![](../assets/media/occ-captures/admin/sites/uuid/edit/located-at-parent-light-mode.png#only-light)
    ![](../assets/media/occ-captures/admin/sites/uuid/edit/located-at-parent-dark-mode.png#only-dark)

...
Reminder Tasks are automatically generated by the system when a requirement becomes due. They usually have a requirement to complete, such as a checklist to fill in, a document to upload or an E-learning to complete. View the Diagram / Table below to view the different kinds of reminder tasks you will likely encounter.
...
Corrective Actions are informative tasks that highlight where action may be required across your sites, assets, or employees. They may relate to reported defects, recommendations, or other issues that have been identified and raised. View the Diagram / Table below to view the different kinds of reminder tasks you will likely encounter.

...
=== "Table"
    ...
    | <span class="mb-label mb-label-lime">Assets</span> | <span class="mb-label mb-label-olive">Checklist</span> | Vehicle/Machinery Pre-use Checks, Ladder Checks or Racking Checks. |
